...
#Systems:
weight_fuell_cell = 2 * (258.66) #(c.g. in wing)
weight_hydrogen_tank = 105 # cg in fuselage (metal liner, mass tank, insulation, polyamide liner) x4
weight_batteries = 2*164 #in the wing
