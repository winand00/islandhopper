from wing_box import make_wingbox, AL7040, n_ult_pos, n_ult_neg
import numpy as np


def iterate_wing_box(t_skin, n_str, size_str, material, n):
    working_designs = {}
    failed_designs = {}
    for t in t_skin:
        for str_n in n_str:
            for size in size_str:
                wingbox = make_wingbox(t, str_n, size, material, n)
...
n = n_ult_pos
print(iterate_wing_box(t_skin, n_str, size_str, AL7040, n))
